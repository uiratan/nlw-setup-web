        ...
        <Popover.Root>
            <Popover.Trigger 
                className={clsx("w-10 h-10  border-2  rounded-lg", {
                    ...
                    'bg-violet-300 border-violet-200': completedPercentage > 0 && completedPercentage < 20,
                    'bg-violet-400 border-violet-300': completedPercentage >= 20 && completedPercentage < 40,
